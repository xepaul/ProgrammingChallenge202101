...
namespace PriceCalculator.Core
{
    ...
    public sealed record ShoppingListAndDiscount(ImmutableList<Option<DiscountedPrice>> DiscountedShoppingList, ImmutableList<DiscountSummary> DiscountsSummary);
    public sealed record ComposableShoppingListAndDiscount(IShopContext ShopContext, ImmutableList<ShoppingCartItem> OriginalShoppingList, ImmutableList<Option<DiscountedPrice>> DiscountedShoppingList, ImmutableList<DiscountSummary> DiscountsSummary);
}
